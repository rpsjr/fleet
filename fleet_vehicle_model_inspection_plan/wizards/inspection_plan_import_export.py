...
class InspectionPlanImportExport(models.TransientModel):
    ...
    def _export_plans(self):
        ...
        self.write({"file_data": content, "filename": "inspection_plans.csv"})
